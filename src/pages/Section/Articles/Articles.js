...
const Articles = () => {
    ...
    const ArticlesMobile = () => {
        ...
        return (
            ...
            <button className={styles.moreBtn} onClick={showArticlesHandler}>View More</button>
          </div>
        );
    };
    ...
    const ArticlesDesk = () => {
        const settings ={
            ...
            return (
                <Slider {...settings} className={styles.slider} style={{width:1160, justifySelf:"center"}}>
                {ArticleDataDesk.map((data)=>(
                    <div className={styles.eachSlide} style={{width:290}}>
                        <div className={styles.card} key={data.index}>
                             <div className={styles.top} style={{ backgroundImage: `url(${data.img})` }}>
                        ...
                        <div className={styles.bottom}>
                            ...
                            <img src={data.heart} alt="heart-button" className={styles.heart} />
