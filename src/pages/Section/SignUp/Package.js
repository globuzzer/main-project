    ...
    return (
        ...
        <div className={styles.content}>
          ...
          <div className={styles.cityBtn}>
            <a href="https://globuzzer.mn.co/sign_up?space_id=195832&from=https%3A%2F%2Fglobuzzer.mn.co%2Fgroups%2F195832%2Ffeed%3Fautojoin%3D1%26autojoin_space_id%3D195832"><button>Let's go</button></a>
          </div>
        </div>
      </div>
    );
